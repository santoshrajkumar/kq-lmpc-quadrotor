...
def run_mpc(tsim=10, task_id = 2, nmpc_flag = False, meas_noise=False):
    ...
    rad_lem, omega_lem, h_lem = 1.0, 0.9, 1.0 # Lemniscate Parameters
    rad_hel, omega_hel, helix_scl = 1.0, 0.9, 10 # helics parameters
    ...
    return X, Xd, u_mpc, comptime, time_sim


X, Xd, u_mpc, comptime, time_sim = run_mpc(tsim=10, task_id = 2, nmpc_flag = False, meas_noise=False)